...
// https://blog.wandoer.com/coding/using-%E5%85%B3%E9%94%AE%E5%AD%97%E5%9C%A8-c-%E4%B8%AD%E7%9A%84%E5%87%A0%E7%A7%8D%E7%94%A8%E6%B3%95.htm
using QjsContext = JSContext;
using JSExceptionHandler = std::function<void(int32_t contextId, const char* message)>;

namespace kraken::binding::qjs {

// 在多线程中，有一种场景是某一个任务只需要执行一次
// 可用 c++11 中的 std:call_once, 函数配合std::once_flag来实现。
// 多个线程同时调用某个函数，std::call_once可以保证多个线程对该函数只调用一次。
